                              ...
                              ItemDamage = (source, target) =>
                                  {
                                      if (source.GetBuffCount("ItemStatikShankCharge") == 100)
                                      {
                                          return new[] { 50, 50, 50, 50, 50, 50, 56, 67, 72, 77, 83, 88, 94, 99, 104, 110, 115, 120 }[Math.Min(source.Level - 1, 17)];
                                      }
                              ...
                              ItemDamage = (source, target) =>
                                  {
                                      if (source.GetBuffCount("ItemStatikShankCharge") == 100)
                                      {
                                          return new[] { 60, 60, 60, 60, 60, 68, 76, 84, 91, 99, 107, 114, 122, 130, 137, 145, 153, 160 }[Math.Min(source.Level - 1, 17)];
                                      }
