namespace Aimtec.SDK.Menu.Theme.Default
{
    ...
    internal class DefaultMenu : IRenderManager<Menu, DefaultMenuTheme>
    {
        ...
        public void Render(Vector2 pos)
        {
            ...
            Aimtec.Render.Text(position + new Vector2((this.Theme.IndicatorWidth  / 2), (this.Theme.MenuHeight - this.Theme.LineWidth) / 2), Color.FromArgb(207, 195, 149), ">", RenderTextFlags.VerticalCenter | RenderTextFlags.HorizontalCenter);
